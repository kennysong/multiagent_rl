    ...
    with open(str(lr), 'w') as f:
        for i in range(1000):
            ...
            for num_episode in range(10000):
                ...
                print("i: {} Num episode:{} Episode Len:{} Return:{} Baseline error:{}".format(i, num_episode, len(episode), cum_return, cum_value_error), file=f)
                ...
                if cum_return > -13:
                    ...
                    print("LEARNED. len: {}. {{'episodes': {}, 'cum_return': {}, 'cum_value_error': {} }},".format(len(episode), num_episode, cum_return, cum_value_error), file=f)
                    break

            if num_episode == 9999:
                print("DID NOT LEARN. len: {}. {{'episodes': {}, 'cum_return': {}, 'cum_value_error': {} }},".format(len(episode), num_episode, cum_return, cum_value_error))
                print("DID NOT LEARN. len: {}. {{'episodes': {}, 'cum_return': {}, 'cum_value_error': {} }},".format(len(episode), num_episode, cum_return, cum_value_error), file=f)
